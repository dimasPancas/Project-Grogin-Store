...
export default function DeleteCategory({ category, handleDeleteModalClose, handleConfirmDelete }) {
  return (
    <Modal
      open={!!category}
    ...
    >
      <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 400, bgcolor: 'background.paper', borderRadius: 8, boxShadow: 24, p: 4 }}>
        <Typography variant="h6" sx={{ textAlign: 'center', mb: 2 }}>Delete Category</Typography>
        <Typography variant="body1" sx={{ textAlign: 'center', mb: 3 }}>Apakah anda yakin ingin menghapus kategori ini?</Typography>
